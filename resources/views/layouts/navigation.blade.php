<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dashboard.graph.index')" :active="request()->routeIs('dashboard')">
                        {{ __('Graphs') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div x-bind:class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('dashboard.graph.edit', 1)" :active="request()->routeIs('dashboard')">
                {{ __('Graph Test') }}
            </x-responsive-nav-link>
        </div>
